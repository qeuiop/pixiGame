...
// Mota recolectable que suelta un enemigo al morir. Puede dar xp normal, ser una fruta
// de valor grande, o ser una mota especial que otorga directamente una mejora.
...
class XPItem extends GameObject {
    constructor(x, y, game, value = 1, esGrande = false, esEspecial = false) {
        // Sprite según el tipo de mota, xp normal, fruta de élite, o hueso de mejora especial
        let sprite = 'xp.png';
